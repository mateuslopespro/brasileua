$(document).ready(function(){
	...
	for(let i = 0;i<companies.length;i++){
		...
		html += '<div class="item-result-title"><a href="http://'+window.location.host+'/page/'+companies[i].url+'">'+companies[i].name+'</a></div>'
		...
		html += '<a href="http://'+window.location.host+'/page/'+companies[i].url+'" class="btn">Mais Informações</a>'
		html += '</div>'
		html +='</div>'
